...
<div class="screen">
  <section class="panel">
    ...
    <div class="panel-footer">
      <button type="button" class="action-btn cancel-btn" onclick="goBack('<%=contextPath%>')">이전</button>
      <button type="button" class="action-btn confirm-btn" onclick="goNext('<%=contextPath%>')">결제 진행</button>
    </div>
